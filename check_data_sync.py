...
def get_disk_details():
	...
	#out = unicode(out, errors="ignore").encode('utf8')
        ...
        out=unicodedata.normalize('NFKD', out).encode('ascii', 'ignore') if isinstance(out, unicode) else unicode(out, errors="ignore").encode('utf8')
...
def get_node_block_devices(disks_map):
    ...
    if not err:
        ...
        print (NS.publisher_id, "Error Message:", err)
        #logger.log(
        #    "debug",
        #    NS.publisher_id,
        #    {"message": err}
